...
public class Q5Tester {
	...
	public void setUp() {
		 ...
		 */
		GDPMapper mapper = new GDPMapper();
		 ...
		 */
		GDPReducer reducer = new GDPReducer();
	...
	public void testMapper() {
		...
		mapDriver.withOutput(new Text("USA"), new DoubleWritable(4.0));
	...
	public void testMapReduce() {
		 ...
		 */
		mapReduceDriver.addOutput(new Text("USA   "), new Text("Avg: 22.000 StdDev: 2.000"));
